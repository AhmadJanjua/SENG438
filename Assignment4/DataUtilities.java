...
/**
*
*This portion of the code was commented out since it contained a condition where the row count is an invalid input.
*Due to how there is already a check for such invalid inputs an IndexOutOfBoundsException is thrown therefore,
*this code is considered unreachable and unnecessary,
*as it does not affect the behavior of the method and removing it resulted in increased mutation coverage.
*
*/
...
/**
*
*This portion of the code was commented out since it contained a condition where the column count is an invalid input.
*Due to how there is already a check for such invalid inputs an IndexOutOfBoundsException is thrown therefore,
*this code is considered unreachable and unnecessary,
*as it does not affect the behavior of the method and removing it resulted in increased mutation coverage.
*
