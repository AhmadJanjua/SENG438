...
//ASSIGNMENT 3 STARTS
    ...
    @Test
    public void combineNormalRange() {
    	Range firstInput = exampleRange[2];
    	Range secondInput = exampleRange[3];
    	Range expectedValue = exampleRange[2];
    	Range actualValue = Range.combine(firstInput, secondInput);
    	assertTrue("Combine is not returning the correct range when both ranges are correct.", actualValue == expectedValue);
    }
    ...
    @Test
    public void shiftNormalTrue() {
    	Range firstInput = exampleRange[2];
    	Range expectedValue = new Range(0.0,10.0);
    	Range actualValue = Range.shift(firstInput, 10);
    	assertTrue("Shift is not returning the correct lower bound.", actualValue.getLowerBound() == expectedValue.getUpperBound());
    ...
    public void getLowerBound_illegalArg() throws NoSuchFieldException, SecurityException, IllegalAccessException {
    	
		Range range = new  Range(0,1);
		Field lower = Range.class.getDeclaredField("lower");
		lower.setAccessible(true);
		lower.setDouble(range, 1.0);
		Field upper = Range.class.getDeclaredField("upper");
    ...
    @Test ( expected = IllegalArgumentException.class)
    public void getUpperBound_illegalArg() throws NoSuchFieldException, SecurityException, IllegalAccessException {
    ...
    @Test ( expected = IllegalArgumentException.class)
    public void getlength_illegalArg() throws NoSuchFieldException, SecurityException, IllegalAccessException {
